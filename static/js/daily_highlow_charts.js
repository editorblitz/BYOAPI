    ...
    renderChart: function(data) {
        ...
        const option = {
            ...
            legend: {
                ...
                itemHeight: 3,
                data: [
                    { name: 'High', icon: 'path://M0,5L4,5L4,7L0,7Z M8,5L12,5L12,7L8,7Z M16,5L20,5L20,7L16,7Z M24,5L28,5L28,7L24,7Z' },
                    { name: 'Low', icon: 'path://M0,5L4,5L4,7L0,7Z M8,5L12,5L12,7L8,7Z M16,5L20,5L20,7L16,7Z M24,5L28,5L28,7L24,7Z' },
                    { name: 'Average', icon: 'path://M0,5L25,5L25,7L0,7Z' }
                ]
            },
            graphic: [
                {
