/**
 * Midday Charts - Multi - Publication-ready NGI multi-location midday comparison charts
...
const MiddayChartsMulti = {
    ...
    init: function() {
        ...
        this.bindEvents();
        this.setupLogToggle();
        this.log('Midday Charts - Multi system initialized.');
    },
    ...
    handleGenerate: async function() {
        try {
            ...
            // Build URL with optional date params - use midday-multi type
            let url = `/api/quick-charts?type=midday-multi&locations=${locations}`;
            if (startDate && endDate) {
                url += `&start_date=${startDate}&end_date=${endDate}`;
                this.log(`Fetching midday prices for ${this.compareList.length} location(s) from ${startDate} to ${endDate}...`);
            } else {
                this.log(`Fetching midday prices for ${this.compareList.length} location(s) (last 12 months)...`);
            }
    ...
    renderChart: function(data) {
        ...
        const option = {
            ...
            title: [{
                text: "NGI's MidDay Alert Prices",
                left: '3%',
                top: '10',
                textStyle: {
                    color: '#003A50',
    ...
    downloadChart: function() {
        ...
        img.onload = () => {
            ...
            canvas.toBlob((blob) => {
                ...
                const filename = 'NGI Midday Prices.webp';
...
document.addEventListener('DOMContentLoaded', () => MiddayChartsMulti.init());
